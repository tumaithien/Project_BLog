...
export const ACT_GET_CHILDREN_COMMENTS_PAGING =
  "ACT_GET_CHILDREN_COMMENTS_PAGING";
...
export const ACT_INIT_COMMENT_CHILDREN_PAGING =
  "ACT_INIT_COMMENT_CHILDREN_PAGING";
...
export function actGetComment({
  ...
  return {
    type:
      parentId === 0 ? ACT_GET_COMMENT_PARENT_POST : ACT_GET_COMMENT_REPLY_POST,
    payload: {
      currentPage,
      comments,
      total,
...
export function actPostNewComment(comment) {
  return {
    type:
      comment.parentId === 0 ? ACT_NEW_COMMENT_PARENT : ACT_NEW_REPLY_COMMENTS,
    payload: { comment },
  };
}
