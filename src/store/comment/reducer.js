...
import {
  ACT_GET_COMMENT_REPLY_POST,
  ACT_GET_COMMENT_PARENT_POST,
  ACT_INIT_COMMENT_CHILDREN_PAGING,
  ACT_NEW_COMMENT_PARENT,
  ACT_NEW_REPLY_COMMENTS,
} from "./actions";
    ...
    case ACT_NEW_REPLY_COMMENTS:
      ...
      return {
        ...
        hashChildPaging: {
          ...
          [parentId]: {
            ...currentChildPaging,
            list: [...currentChildPaging.list, action.payload.comment],
            exclude: [...currentChildPaging.exclude, action.payload.comment.id],
          },
        },
      };
